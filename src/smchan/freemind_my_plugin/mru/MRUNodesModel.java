...
/**
 * Data model for list of MRU {@link MindMapNode} with adapters to register to the current mind map as per user
 * selection and to convert "map node events" into MRU list updates.
 */
